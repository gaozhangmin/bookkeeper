...
public interface BookKeeperServerStats {
    ...
    String LABEL_REJECT_REASON = "REJECT_REASON";
    String REJECT_REASON_QUEUE_FULL = "QUEUE_FULL";
    String REJECT_REASON_MEMORY_FULL = "MEMORY_FULL";
    String REJECT_REASON_OPERATION_REJECTED = "OPERATION_REJECTED";
    ...
    String NEW_ENSEMBLE_FILTER_RACK_BLACKLIST_COUNT = "NEW_ENSEMBLE_FILTER_RACK_BLACKLIST_TOTAL";
    String READ_FILTER_RACK_BLACKLIST_COUNT = "READ_FILTER_RACK_BLACKLIST_TOTAL";
    ...
    String MEMORY_USAGE_RATIO_SUFFIX = "_USAGE_RATIO";
