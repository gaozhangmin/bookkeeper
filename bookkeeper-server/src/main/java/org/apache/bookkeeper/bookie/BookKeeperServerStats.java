...
public interface BookKeeperServerStats {
    ...
    String COLD_STORAGE_GET_ENTRY = "COLD_STORAGE_GET_ENTRY";
    ...
    //cold storage archive related counters
    String RECLAIMED_DISK_CACHE_SPACE_BYTES = "RECLAIMED_DISK_CACHE_SPACE_BYTES";
    String ARCHIVED_ENTRY_LOG_SIZE_BYTES = "ARCHIVED_ENTRY_LOG_SIZE_BYTES";
    String DISK_CACHE_ACTIVE_ENTRY_LOG_COUNT = "DISK_CACHE_ACTIVE_ENTRY_LOG_COUNT";
    String DISK_CACHE_ACTIVE_ENTRY_LOG_SPACE_BYTES = "DISK_CACHE_ACTIVE_ENTRY_LOG_SPACE_BYTES";
    String ARCHIVE_THREAD_RUNTIME = "ARCHIVE_THREAD_RUNTIME";

    String EXTRACT_METADATA_RUNTIME = "EXTRACT_METADATA_RUNTIME";
