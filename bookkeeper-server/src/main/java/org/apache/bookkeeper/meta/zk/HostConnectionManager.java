...
public final class HostConnectionManager {
    ...
    public HostConnectionManager(Collection<InetSocketAddress> serverAddresses,
                                 long randomnessSeed, ZKClientConfig clientConfig) {
    ...
    public HostConnectionManager(Collection<InetSocketAddress> serverAddresses,
        ...
        LOG.info("HostConnectionManager initialized with {} servers", serverAddresses);
    }
     ...
     */
    synchronized boolean updateServerList(Collection<InetSocketAddress> serverAddresses,
